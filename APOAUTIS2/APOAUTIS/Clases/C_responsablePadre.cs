...
namespace APOAUTIS.Clases
{
    public class C_responsablePadre
    {
        ...
        public C_responsablePadre(int codAlumno, int codResp, string nombResp, int idResp, string domicilioResp, string profesionResp1, string oficioREsp, string lugarTrabRes, string telefonoCasaResp, string celResp, string trabajoResp, string correoResp, int tipoRes)
        {
            CodAlumno = codAlumno;
            CodResp = codResp;
            NombResp = nombResp;
