...
namespace APOAUTIS.Clases
{
    class C_MontoMens : Conexion
    {
        ...
        {
            cnx.Open();
            sql = string.Format("select B.CodMatricula as 'Codigo Matricula',  B.MarDesc as 'Tipo de matricula',B.Fecha as 'Fecha de realizacion', A.CodAlumno as 'Codigo de Alumno', A.NomAlumno as 'Nombre de Alumno', B.Jornada as 'Jornada', B.AnioIngreso as 'Año de Ingreso',B.CuotaPago as 'Cuota de pago' from alumnos as A inner join matricula as B on A.CodAlumno = B.Alumnos_CodAlumno order by B.CodMatricula desc ");
